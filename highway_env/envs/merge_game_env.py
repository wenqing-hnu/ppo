...
class Merge_game_env(AbstractEnv):
    ...
    def __init__(self, avg_speed= -1, min_density=0., max_density=1., 
                 cooperative_prob = 0., mpc_control=True, safe_check=False, use_mpc_cost =False):
    ...
    def _cost(self, action: int) -> float:
        ...
        def collision_check(vehicle_1, vehicle_2):
            ...
            v1_future_position_x_end = current_position[0] + vehicle_1.speed * dt * N_1 # 0.3s 
            v1_future_position_x_start = current_position[0] + vehicle_1.speed *dt * N_2 # 0.8s
            v2_future_position_x = vehicle_2.future_state[(N_1+1)*4, 0]  # 0.5s
            v2_future_position_y = vehicle_2.future_state[(N_1+1)*4+1, 0] # 0.5s
        ...
        cost = wrong_action_cost + crash_cost + predict_cost
        return cost, self.pre_stop
    ...
    def _is_terminal(self) -> bool:
        ...
        terminal = (self.vehicle.crashed or terminal_crashed) or terminal_end  # self.vehicle.position[0] > END_DIS
