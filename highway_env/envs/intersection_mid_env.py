...
class IntersectionmidEnv(AbstractEnv):
    ...
    def _make_vehicles(self, n_vehicles: int = 10) -> None:
        ...
        for t in range(n_vehicles - 1):
            self._spawn_vehicle(np.linspace(0, 120, n_vehicles)[t], spawn_probability=1, go_straight=False, position_deviation=0.5, speed_deviation=0.2)
    ...
    def _spawn_vehicle(self,
        ...
        vehicle = vehicle_type.make_on_lane(self.road, ("o" + str(route[0]), "ir" + str(route[0]), 0),
                                            longitudinal=longitudinal + 5 + self.np_random.randn() * position_deviation * 2,
...
register(
    id='intersectionmid-v0',
    entry_point='highway_env.envs:IntersectionmidEnv',
)
