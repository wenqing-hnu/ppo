...
class IntersectioneasyEnv(AbstractEnv):
    ...
    def _make_vehicles(self, n_vehicles: int = 10) -> None:
        ...
        for t in range(n_vehicles - 1):
            self._spawn_vehicle(np.linspace(0, 120, n_vehicles)[t], spawn_probability=1, go_straight=True, position_deviation=5.5, speed_deviation=0.2)
...
register(
    id='intersectioneasy-v0',
    entry_point='highway_env.envs:IntersectioneasyEnv',
)
